...
return [
    ...
    */
    ...
    'module_labels' => [
        ...
        'Re-Inspections'               => 'Review Re-Inspections',
        'Installation & Rectification' => 'Review Installations',
        'Reports'                      => 'Reports',
    ],
            ...
            [
                ...
                'items'   => [
                    [
                        ...
                        'id'       => 'sidebarUserRoleR',
                        'canany'   => ['manage users', 'assign roles', 'permission'],
                        'children' => [
                            ...
                            ['permission' => 'permission',   'icon' => 'ri-key-2-line',          'route' => 'admin.permissions.index', 'pattern' => 'admin.permissions.*'],
                        ],
                    ],
                    [
