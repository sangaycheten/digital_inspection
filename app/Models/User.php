...
#[Fillable(['name', 'email', 'password', 'has_password', 'force_password_change', 'email_verified_at', 'credentials_sent_at', 'created_by', 'updated_by', 'client_id', 'avatar', 'timezone'])]
#[Hidden(['password', 'remember_token'])]
class User extends Authenticatable
{
    /** @use HasFactory<UserFactory> */
    use HasFactory, Notifiable, HasRoles, LogsActivity, SoftDeletes, HasUuids;
