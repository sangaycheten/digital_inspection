        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Total Inspections</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">System Users</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $userCount ?? 0 }}</h4>
                            <a href="{{ route('admin.users.index') }}" class="text-decoration-underline">Manage users</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                        ...
                        <table class="table table-sm table-borderless mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="fw-medium">{{ config('app.name') }}</td>
                                </tr>
                                <tr>
                                    <td class="text-muted">Laravel Version</td>
                                    <td class="fw-medium">{{ app()->version() }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger-subtle text-danger">System Administrator</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
